  ...
  <div class="container mt-4 pt-0">
    <div class="row justify-content-center my-3">
      <div class="botones col-sm-6">
        ...
        <a role="button" class="btn btn-primary" style="background-color: #ac2bac;" href="http://facebok.com" target="_blank">
          <i class="bi bi-instagram" style="font-size:24px;"></i>
        </a>
        <a role="button" class="btn btn-primary" style="background-color: #25d366;" href="http://facebok.com" target="_blank">
    ...
    <div class="row justify-content-center my-4">
        Desarrollado por Victor Mita con ❤️ 
    </div>
  </div>
</div>
</template>
